...
(function(){
    ...
    window.visualizationSong = function (analyser, canvas, options) {
        ...
        var ctx = canvas.getContext('2d'),
            ...
            array = new window.Uint8Array(analyser.frequencyBinCount),
        ...
        var requestVisualization = function (){
            ...
            window.requestAnimationFrame(requestVisualization);
        };
